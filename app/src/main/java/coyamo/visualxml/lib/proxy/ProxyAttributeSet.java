...
public class ProxyAttributeSet {
    ...
    private static Map<String, Map<String, String>> enumMap = new ArrayMap<>();
    //attr中flag值的映射（可以a|b|c这么设置的那种）
    private static Map<String, Map<String, Integer>> flagMap = new ArrayMap<>();

    static {
        Map<String, String> orientationMap = new ArrayMap<>();
        enumMap.put("orientation", orientationMap);
        orientationMap.put("vertical", "1");
        orientationMap.put("horizontal", "0");


        Map<String, String> layoutMap = new ArrayMap<>();
        ...
        Map<String, String> importantForAccessibilityMap = new ArrayMap<>();
        ...
        Map<String, String> verticalScrollbarPositionMap = new ArrayMap<>();
        ...
        Map<String, String> typefaceMap = new ArrayMap<>();
        ...
        Map<String, String> ellipsizeMap = new ArrayMap<>();
        ...
        Map<String, String> textDirectionMap = new ArrayMap<>();
        ...
        Map<String, String> scrollbarStyleMap = new ArrayMap<>();
        ...
        Map<String, String> overScrollModeMap = new ArrayMap<>();
        ...
        Map<String, String> layoutDirectionMap = new ArrayMap<>();
        ...
        Map<String, String> layerTypeMap = new ArrayMap<>();
        ...
        Map<String, String> drawingCacheQualityMap = new ArrayMap<>();
        ...
        Map<String, String> visibilityMap = new ArrayMap<>();
    ...
    static {
        ...
        Map<String, Integer> scrollbarsMap = new ArrayMap<>();
        ...
        Map<String, Integer> fadingEdgeMap = new ArrayMap<>();
        ...
        Map<String, Integer> gravityMap = new ArrayMap<>();
