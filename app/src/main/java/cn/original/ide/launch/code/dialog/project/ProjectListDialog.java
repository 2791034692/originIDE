...
public class ProjectListDialog extends AppCompatDialog {
    ...
    public ProjectListDialog(@NonNull Context context, @StyleRes int theme) {
    ...
    protected ProjectListDialog(@NonNull Context context, boolean cancelable,
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        final FrameLayout container = (FrameLayout) View.inflate(getContext(), R.layout.dialog_project_add_item_main, null);
        coordinator = (CoordinatorLayout) container.findViewById(R.id.c);
